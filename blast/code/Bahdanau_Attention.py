...
bi_lstm, fh, fc, bh, bc = Bidirectional(
    LSTM(latent_dim, dropout=0.5, activation='relu', return_sequences=True, return_state=True))(encoder_dense_output)
...
# 인코더의 스테이트만 가지고 갈거에용
encoder_states = attention_weights
...
model.save_weights('results/attention_mitar_70.h5')
